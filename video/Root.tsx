...
const fallback = {
  schemaVersion: '2.0',
  identity: { projectId: 'preview', topicId: 'preview', title: 'Signal 40 财经事实视频', locale: 'zh-CN', brand: 'Signal 40', createdAt: '2026-09-08T00:00:00.000Z' },
  research: { snapshotId: 'preview', algorithmVersion: 'preview', claims: [{ id: 'claim_1', text: '每一条财经事实，都应该能够回到它的来源。', kind: 'fact', quantity: null, evidence: [{ sourceId: 'source_1', articleRevisionId: null, url: 'https://example.com', stance: 'supports', quote: 'Preview', observedAt: '2026-09-08T00:00:00.000Z', locator: { type: 'url', value: 'https://example.com' } }] }], conflicts: [], approvedHash: 'preview' },
  script: { version: 1, title: 'Signal 40', targetDurationSeconds: 45, disclaimer: '本内容仅供信息参考，不构成投资建议。', modelVersion: 'preview', promptVersion: 'preview', humanModifiedBy: null, humanModifiedAt: null, lines: [{ id: 'line_1', text: '每一条财经事实，都应该能够回到它的来源。', screenText: '事实可回溯', claimIds: ['claim_1'], pronunciationHints: {} }, { id: 'line_2', text: '继续观察原始数据是否延续。', screenText: '持续观察', claimIds: [], pronunciationHints: {} }] },
  timeline: [
    { id: 'hook', startFrame: 0, durationFrames: 150, kind: 'hero-number', narrationLineIds: ['line_1'], visualId: 'visual_hook', transition: 'cut', visualIntent: '建立证据优先主题', screenText: '每一条财经事实，都应回到来源', sourceFootnote: 'Signal 40 preview contract', motion: '标题淡入' },
